...
async def invite_user_to_channel(
    ...
    if invites_blocked:
        embed = discord.Embed(
            title=f"{lang_constants.ERROR_EMOJI} {_('common.error', inviter_lang)}",
            description=_('temp_voice.errors.user_has_invites_disabled', inviter_lang).format(
    ...
    try:
        ...
        dm_embed = discord.Embed(
            ...
            description=_('temp_voice.dm_invitation.invitation_message', target_lang).format(
                interaction=type('obj', (object,), {'user': inviter})()  # Mock interaction object
            ),
